            ...
            myAjax({
                ...
                success: function (res) {
                    ...
                    res.shadow = opt.shadow || res.shadow || "<div id='ShareInstallDom' style='font-size:30px;color:#fff;text-align:right;" +
                        ...
                        "width:100%;height:100%;z-index:10000;'><img src='http://imgmini.eastday.com/shareinstall/admin/assets/1530617476_tip-icon.png' alt='' style='width:60%;margin-top:20px;'></div>"
